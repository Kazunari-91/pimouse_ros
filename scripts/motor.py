...
class Motor():
    def __init__(self):
        ...
        self.sub_cmd_val = rospy.Subscriber('cmd_vel', Twist, self.callback_cmd_vel)
    ...
    def set_power(self, onoff=False):
        ...
        try:
            ...
            rospy.logerr("cannot wrute to " + en)
        return False
    ...
    def onoff_response(self, onoff):
        ...
        d.message = "ON" if self.is_on else "0FF"
        return d
    ...
    def callback_cmd_vel(self, message):
        ...
        forward_hz = 80000.0 * message.linear.x / (90* math.pi)
    ...
    def callback_tm(self, message):
        ...
        try:
            ...
            rospy.logeer("cannot wrute to " + dev)
            return False
        return True
